...
![alt text](./30_adc_image_bak/image.png)

## 2 时钟

根据下面STM32H7的ADC表，<font color="red">ADC频率最大36Mhz，需要开启BOOST = 1 </font>

![alt text](./30_adc_image_bak/image-5.png)

可以将PLL2设置为72Mhz，ADC预分频设置为2（异步时钟模式），就是36Mhz。（ADC工作频率超过36M会不稳定）。

<font color= "green">上面使用的是异步时钟模式，暂时还没研究异步和同步的区别</font>

![alt text](./30_adc_image_bak/image-8.png)

![alt text](./30_adc_image_bak/image-6.png)

![alt text](./30_adc_image_bak/image-7.png)

## 3 

![alt text](./30_adc_image_bak/image-3.png)

![alt text](./30_adc_image_bak/image-4.png)
...
![alt text](./30_adc_image_bak/image-9.png)



[参考： STM32H7 ADC最大速率](https://blog.csdn.net/qq_41555003/article/details/147052899)

[参考：STM32H7 ADC交替采样实现8M采样率(14bit) 与高速USB（VCP）传输](https://blog.csdn.net/2404_88276917/article/details/143108040)

[参考： STM32G474CubeMX+CLion双重ADC交替采样实现2M+2M=4M](https://blog.csdn.net/yjta520/article/details/53396702)

[参考：STM32H7 HAL库CubeMX 双重ADC模式同步采样详细配置+FFT计算相位差](https://www.cnblogs.com/Banyee/p/18340625)

[参考： ADC—电压采集](https://doc.embedfire.com/mcu/stm32/h743prov/hal/zh/latest/book/ADC.html)